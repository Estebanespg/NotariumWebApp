    ...
    <>
      ...
      <aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-52 h-dvh transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div className="flex flex-col h-full px-3 py-4 overflow-y-auto bg-gray-800">
          <Link href="/main/students" className="flex items-center ps-2.5 mb-5">
          ...
          <ul className="space-y-3 font-medium mt-2">
            <li>
              <Link href="/main/students" className={`flex items-center p-2 ${currentRoute === '/main/students' ? 'text-white' : 'text-gray-400'} transition duration-100 hover:text-white rounded-lg hover:bg-gray-700 group`}>
            ...
            <li>
              <Link href="/main/settings" className={`flex items-center p-2 ${currentRoute === '/main/settings' ? 'text-white' : 'text-gray-400'} transition duration-100 hover:text-white rounded-lg hover:bg-gray-700 group`}>
